...
public class StopwatchMain extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
            new StopwatchPlaceholder(this).register();
        } else {
            getLogger().info("Could not find PlaceholderAPI! This plugin is optional.");
        }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                if (isRunning) {
                    ...
                    secondsOut = Integer.toString(totalSecs);
                    ...
                    if (hours > 0) {
                     ...
                     timerMessage = Util.replace(timeMessage, time);
